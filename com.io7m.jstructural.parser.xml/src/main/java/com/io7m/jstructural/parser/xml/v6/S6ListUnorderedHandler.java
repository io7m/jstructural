...
final class S6ListUnorderedHandler extends S6ElementHandler
{
  private final SListUnordered.Builder<SParsed> list_builder;

  S6ListUnorderedHandler(
    final S6ElementHandler in_parent,
    final Attributes in_attributes,
    final Locator2 in_locator)
  {
    super(in_parent, in_locator);
    this.list_builder = SListUnordered.builder();
