...
final class S6LinkExternalHandler extends S6ElementHandler
{
  private final SLinkExternal.Builder<SParsed> link_builder;

  S6LinkExternalHandler(
    final S6ElementHandler in_parent,
    final Attributes in_attributes,
    final Locator2 in_locator)
  {
    super(in_parent, in_locator);
    this.link_builder = SLinkExternal.builder();
    ...
    this.link_builder.setTarget(URI.create(am.get("target")));
  }
