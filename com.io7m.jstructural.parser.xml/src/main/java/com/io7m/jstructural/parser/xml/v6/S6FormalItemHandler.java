...
final class S6FormalItemHandler extends S6ElementHandler
{
  private final SFormalItem.Builder<SParsed> formal_item_builder;
  ...
  void onChildCompleted(final SModelType<SParsed> c)
  {
    ...
    this.formal_item_builder.addContent((SInlineAnyContentType<SParsed>) c);
  }
  ...
  @Override
  SFormalItem<SParsed> finishContent()
  {
    return this.formal_item_builder.build();
  }
}
